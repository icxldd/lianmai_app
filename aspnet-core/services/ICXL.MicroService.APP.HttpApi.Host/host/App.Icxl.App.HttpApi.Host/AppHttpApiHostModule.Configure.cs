...
public partial class AppHttpApiHostModule
{
    public static string ApplicationName { get; set; } = "AppService";
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<AppHttpApiHostModule>("App.Icxl.App");
        });
    }
    ...
    private void ConfigureLocalization()
    {
        ...
        Configure<AbpLocalizationPersistenceOptions>(options =>
        {
            ...
            options.AddPersistenceResource<AppResource>();
        });
