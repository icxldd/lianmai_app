...
public abstract class EfCoreAppRepository<TEntity, TKey> :
    EfCoreDataProtectionRepository<IAppDbContext, TEntity, TKey>,
    IAppBasicRepository<TEntity, TKey>
    where TEntity : class, IEntity<TKey>
{
    protected EfCoreAppRepository(
        IDbContextProvider<IAppDbContext> dbContextProvider, 
